    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
      ...
      <div className="card">
        ...
        <div className="space-y-4">
          <div className="flex gap-6">
            <div className="flex items-center gap-2">
              <input id="comment_auto_reply" name="comment_auto_reply" type="checkbox" defaultChecked={settings?.comment_auto_reply ?? true} className="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-600" />
              <label htmlFor="comment_auto_reply" className="text-sm text-gray-700">Auto-reply to post comments</label>
            </div>
            <div className="flex items-center gap-2">
              <input id="dm_automation_enabled" name="dm_automation_enabled" type="checkbox" defaultChecked={settings?.dm_automation_enabled ?? true} className="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-600" />
              <label htmlFor="dm_automation_enabled" className="text-sm text-gray-700">Send private messages to commenters</label>
            </div>
          </div>
          <p className="text-xs text-gray-500">When someone comments on a business post with interest signals (e.g. &quot;price?&quot;, &quot;interested&quot;), the bot can reply publicly and/or message them directly.</p>
        </div>
      </div>
